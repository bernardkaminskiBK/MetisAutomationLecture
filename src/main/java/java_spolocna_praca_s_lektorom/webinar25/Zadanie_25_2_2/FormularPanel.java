...
public class FormularPanel extends JPanel
{
    ...
    public FormularPanel()
    {
        ...
        DefaultListModel<VekovaKategoria> vekoveKategoriaModel = new DefaultListModel<>();
        vekoveKategoriaModel.addElement(new VekovaKategoria(0, "menej ako 18 rokov"));
        vekoveKategoriaModel.addElement(new VekovaKategoria(1, "od 18 do 60 rokov"));
        vekoveKategoriaModel.addElement(new VekovaKategoria(2, "viac ako 60 rokov"));
        ...
        btnOK.addActionListener(new ActionListener()
        {
            ...
            public void actionPerformed(ActionEvent e)
            {
                ...
                VekovaKategoria vekovaKategoria = lstVekoveKategorie.getSelectedValue();

                // "vynulujeme" textove polia
                txtMeno.setText("");
                txtZamestnanie.setText("");

                FormularUdalost udalost = new FormularUdalost(this, meno, zamestnanie, vekovaKategoria.getId());
